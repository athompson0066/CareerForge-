...
import { Wand2, Palette, Share2, Smartphone, Monitor, PanelLeftClose, PanelLeftOpen } from 'lucide-react';
...
const App: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex flex-col">
      ...
      {/* Main Content */}
      <main className="flex-1 max-w-7xl mx-auto w-full p-4 md:p-8 flex gap-8 h-[calc(100vh-64px)] overflow-hidden">
        ...
        <div className={`flex-1 flex flex-col bg-slate-200/50 rounded-xl border border-slate-200 overflow-hidden relative shadow-inner transition-all duration-300 ${activeTab === 'editor' ? 'hidden' : 'flex'} md:flex`}>
